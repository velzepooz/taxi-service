...
CREATE INDEX idx_cars_manufacturer ON "Car" (LOWER(manufacturer) varchar_pattern_ops);
CREATE INDEX idx_cars_model ON "Car" (LOWER(model) varchar_pattern_ops);

-- Add cars seed
INSERT INTO "Car" (year, manufacturer, model) VALUES
(1909, 'Ford', 'Model T'),
